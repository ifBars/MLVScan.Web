...
import { getScanSeoPage } from "@/seo/routes"

const ScanPage = () => {
  return (
    <>
      <Seo page={getScanSeoPage()} />
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 font-display bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-cyan-400">
              Browser-Based Unity Mod Scanner
            </h1>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Use MLVScan as a local Unity mod antivirus for suspicious MelonLoader and BepInEx assemblies. All processing happens locally in your browser using WebAssembly.
            </p>
          </div>
