...
const advisories: AdvisoryMeta[] = [
  ...
  },
  {
    ...
    description: 'Analysis of a malicious reupload distributed as Search Bar / Customer Search Bar that downloads Venticularjpeggerson.exe from minecraftmods.xyz into %TEMP% and executes it.',
    contentPath: '2026-03-malware-customer-search-bar.mdx',
    keywords: ['malware', 'search-bar', 'customer-search-bar', 'webclient', 'download-and-execute', 'minecraftmods.xyz', 'melonloadermod55'],
  },
  {
