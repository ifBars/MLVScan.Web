...
const advisories: AdvisoryMeta[] = [
  ...
  },
  {
    ...
    description: 'Analysis of a malicious Stardew Valley SMAPI package distributed as AutoBarnCoopDoor that retrieves remote text, converts it into runtime command arguments, and launches the result through a hidden PowerShell process.',
    contentPath: '2026-09-malware-autobarncoopdoor.mdx',
    keywords: ['malware', 'stardew-valley', 'smapi', 'nexus-mods', 'autobarncoopdoor', 'remote-text', 'powershell', 'dynamic-command', 'hidden-execution'],
  },
  {
    id: 'malware-blockchain-java-stager-2026',
    title: 'Malware Analysis: Blockchain-Resolved Java Stager Packages',
    slug: '2026-09-malware-blockchain-java-stager',
    type: 'malware-analysis',
    familyId: 'family-blockchain-java-stager-v1',
    publishedDate: '2026-09-18',
    description: 'Analysis of malicious Stardew Valley SMAPI packages distributed as Polygamy, ValleyDrone, and ValleyMorning that conceal Java payload staging behind blockchain RPC discovery, encoded strings, embedded archives, or redirected process input.',
    contentPath: '2026-09-malware-blockchain-java-stager.mdx',
    keywords: ['malware', 'stardew-valley', 'smapi', 'nexus-mods', 'polygamy', 'valleydrone', 'valleymorning', 'blockchain-rpc', 'java', 'jar', 'xor'],
  },
  {
    id: 'malware-pawns-app-dropper-2026',
    title: 'Malware Analysis: Pawns.app Autorun Dropper Packages',
    slug: '2026-09-malware-pawns-app-dropper',
    type: 'malware-analysis',
    familyId: 'family-pawns-app-dropper-v1',
    publishedDate: '2026-09-18',
    description: 'Analysis of malicious Mount & Blade II: Bannerlord packages distributed as BetterPatrols and BloodAndBanners that download an archive, seed Pawns.app state, add per-user Run-key persistence, and launch the installed executable hidden.',
    contentPath: '2026-09-malware-pawns-app-dropper.mdx',
    keywords: ['malware', 'bannerlord', 'nexus-mods', 'betterpatrols', 'bloodandbanners', 'pawns-app', 'run-key', 'persistence', 'hidden-execution'],
  },
  {
