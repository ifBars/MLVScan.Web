  ...
  return (
    <>
      ...
      <ul className="list-disc list-inside space-y-2 text-gray-300 mb-6 ml-4">
        ...
        <li>If you host docs or validators against <code>mlvscan.com</code>, also publish the generated schema path from Core so the schema <code>$id</code> resolves correctly.</li>
      </ul>
      ...
      <div className="rounded-lg border border-gray-700 bg-gray-900/40 p-4 mb-6">
        ...
        <p className="text-sm text-gray-300 mb-2">
          <strong className="text-white">@mlvscan/wasm-core</strong> re-exports generated scan-result types that come from <code>MLVScan.Core/Models/Dto/</code>. Prefer importing those types instead of redefining your own interfaces.
        </p>
        <p className="text-sm text-gray-300">
          Inside this mono-repo, the Web, API, and Tauri projects additionally point <code>@mlvscan/schema</code> at the generated Core artifact so every surface stays aligned.
        </p>
      </div>
