...
public void RestartGame() {
    ...
    Application.Quit();
      ...
      <p className="text-gray-400 text-sm mb-4">
        Version context: this advisory documents affected historical Core builds. Current MLVScan.Core releases include
        contextual suppression for the safe patterns described below, so the same sample may scan cleanly or report
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-300 mb-6">
        ...
        <li>
          <strong>Current process restart:</strong> Recognizes the pattern <code>Process.GetCurrentProcess().MainModule.FileName</code> → <code>Process.Start()</code>
        </li>
      </ul>
