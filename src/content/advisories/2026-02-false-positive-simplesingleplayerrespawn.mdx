...
Harmony.Patch(method, prefix: new HarmonyMethod(patch));`}
      ...
      <p className="text-gray-400 text-sm mb-4">
        Version context: this advisory documents affected historical Core builds. Current MLVScan.Core releases use
        contextual dynamic-load analysis, so the same sample may scan cleanly or report different diagnostic wording.
      </p>
      <ul className="list-disc pl-6 space-y-2 text-gray-300 mb-6">
